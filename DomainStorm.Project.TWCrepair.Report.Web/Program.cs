...
try
{
    ...
    if (builder.Configuration.GetSection("ENVIRONMENT").Value == "Staging")
    {
        ...
        builder.Services.AddScoped<IGetService<RA019, string>, StagingServices.RA019Service>();
    ...
    else
    {
        ...
        builder.Services.AddScoped<IGetService<RA019, string>, MockServices.RA019Service>();
