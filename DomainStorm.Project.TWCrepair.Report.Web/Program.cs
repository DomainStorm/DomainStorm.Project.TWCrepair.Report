...
try
{
    ...
    if (builder.Configuration.GetSection("ENVIRONMENT").Value == "Staging")
    {
		...
		builder.Services.AddScoped<IGetService<DA009, string>, StagingServices.DA009Service>();
		builder.Services.AddScoped<IGetService<DA010, string>, StagingServices.DA010Service>();
		builder.Services.AddScoped<IGetService<DA011, string>, StagingServices.DA011Service>();
		builder.Services.AddScoped<IGetService<DA012, string>, StagingServices.DA012Service>();
    ...
    else
    {
		...
		builder.Services.AddScoped<IGetService<DA009, string>, MockServices.DA009Service>();
		builder.Services.AddScoped<IGetService<DA010, string>, MockServices.DA010Service>();
		builder.Services.AddScoped<IGetService<DA011, string>, MockServices.DA011Service>();
		builder.Services.AddScoped<IGetService<DA012, string>, MockServices.DA012Service>();
    ...
    if (!string.IsNullOrWhiteSpace(builder.Configuration["SqlDbOptions:ConnectionString"]))
    {
        ...
        builder.Services
           .AddTransient<IRepository<Models.Import.ImportHoliday>, SqlDbRepository<Models.Import.ImportHoliday>>();
        builder.Services
            .AddScoped<GetRepository<IRepository<Models.Import.ImportHoliday>>>(
                c => c.GetRequiredService<IRepository<Models.Import.ImportHoliday>>);
        ...
        builder.Services
           .AddTransient<IRepository<Models.ExecuteControl>, SqlDbRepository<Models.ExecuteControl>>();
        builder.Services
        ...
        builder.Services
            .AddScoped<GetRepository<IRepository<Models.DepartmentCodeMapping>>>(
                c => c.GetRequiredService<IRepository<Models.DepartmentCodeMapping>>);
