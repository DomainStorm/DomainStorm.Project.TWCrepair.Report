...
public class RA049Service : IGetService<RA049, string>
{
    ...
    private async Task<RA049> QueryRA049(QueryRA049 condition)
    {
        ...
        if(checkAchivement != null) 
        {
            ...
            result = _mapper.Map<RA049>(checkAchivement);
            ...
            result.MinFlowCompare = new RA049_DiffAndRate(checkAchivement.MinFlowBefore, checkAchivement.MinFlowAfter); //從範本看, 差異值 =  檢修後 - 檢修前, 
        }
        else
        {
            result = new RA049();
