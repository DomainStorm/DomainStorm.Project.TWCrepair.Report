...
public class RA023Service : IGetService<RA023, string>
{
    ...
    private async Task<RA023> QueryRA023(QueryRA023 condition) 
    {
        ...
        {
            FormId =  x.FormId,
            FixUnit = x.FixFormProperty.FixUnit != null ? x.FixFormProperty.FixUnit.Name : "",
            CaseAttribute = x.FixFormProperty.CaseAttribute != null ? x.FixFormProperty.CaseAttribute.Name : "",
            CaseAttributeNotLeackage = x.FixFormProperty.CaseAttributeNotLeackage != null ? x.FixFormProperty.CaseAttributeNotLeackage.Name : "",
