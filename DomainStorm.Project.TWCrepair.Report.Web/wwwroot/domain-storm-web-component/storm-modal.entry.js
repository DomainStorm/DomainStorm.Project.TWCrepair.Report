...
function requireSweetalert2_all () {
	...
	(function (module, exports) {
		...
		})(sweetalert2_all, (function () { 'use strict';
...
`;
	...
	} (sweetalert2_all$1, sweetalert2_all$1.exports));
...
const StormModal = class {
    ...
    async fire(callback) {
        await Swal.fire({
            ...
            this.close.emit(result.isConfirmed);
            if (callback)
    ...
    componentDidLoad() {
        this.slotRef.assignedElements().map(el => {
            this.templateRef.content.appendChild(el);
        });
    }
    render() {
        return (h(Host, { key: '68af0529060b12bf9cf70115c6bbb4ee0ed9fe63' }, h("template", { key: 'b251128399342b44fb836c2e84f740d1173abd02', ref: el => (this.templateRef = el) }, h("slot", { key: 'ca655b0a5fc7898d8ecb89fdcb810b4c4120d5b4', ref: el => (this.slotRef = el) }))));
    }
};
StormModal.style = stormModalCss;

export { StormModal as storm_modal };
//# sourceMappingURL=storm-modal.entry.esm.js.map

//# sourceMappingURL=storm-modal.entry.js.map