...
var DataTable$1 = function ( selector, options )
{
	...
	for ( var fn in DataTable$1.ext.internal ) {
		if ( fn ) {
	...
	this.each(function() {
		...
		var oSettings = $.extend( true, {}, DataTable$1.models.oSettings, {
		...
		$.extend( oClasses, DataTable$1.ext.classes, oInit.oClasses );
...
function _fnLanguageCompat( lang )
{
	...
	var defaults = DataTable$1.defaults.oLanguage;
...
function _fnBrowserDetect( settings )
{
	...
	$.extend( settings.oBrowser, DataTable$1.__browser );
...
function _fnAddColumn( oSettings, nTh )
{
	...
	var oCol = $.extend( {}, DataTable$1.models.oColumn, oDefaults, {
	...
	searchCols[ iCol ] = $.extend( {}, DataTable$1.models.oSearch, searchCols[ iCol ] );
...
function _fnAddData ( oSettings, aDataIn, nTr, anTds )
{
	...
	var oData = $.extend( true, {}, DataTable$1.models.oRow, {
		src: nTr ? 'dom' : 'data',
		idx: iRow
	} );
...
function _fnAddOptionsHtml ( oSettings )
{
	...
	for ( var i=0 ; i<aDom.length ; i++ )
	{
		...
		else if ( DataTable$1.ext.feature.length !== 0 )
		{
			/* Plug-in features */
			var aoFeatures = DataTable$1.ext.feature;
...
function _fnAjaxParameters( settings )
{
	...
	var legacy = DataTable$1.ext.legacy.ajax;
	if ( legacy === null ) {
...
function _fnFilter( settings, input, force, regex, smart, caseInsensitive )
{
	...
	if ( DataTable$1.ext.search.length !== 0 ) {
		force = true;
	}
...
function _fnFeatureHtmlPaginate ( settings )
{
	var
		...
		plugin = DataTable$1.ext.pager[ type ],
 ...
 *  @memberof DataTable#oApi
 */
var _fnThrottle = DataTable$1.util.throttle;
	...
	for ( i=0 ; i<nestedSort.length ; i++ )
	{
		...
		for ( k=0, kLen=aDataSort.length ; k<kLen ; k++ )
		{
			...
			aSort.push( {
				...
				type:      sType,
				formatter: DataTable$1.ext.type.order[ sType+"-pre" ]
			} );
		}
	}
...
function _fnSort ( oSettings )
{
	var
		...
		sDataType, nTh,
		aiOrig = [],
		oExtSort = DataTable$1.ext.type.order,
 ...
 */
DataTable$1.versionCheck = DataTable$1.fnVersionCheck = function( version )
{
	var aThis = DataTable$1.version.split('.');
 ...
 *    }
 */
DataTable$1.isDataTable = DataTable$1.fnIsDataTable = function ( table )
{
	var t = $(table).get(0);
	var is = false;
	...
	$.each( DataTable$1.settings, function (i, o) {
 ...
 *    } );
 */
DataTable$1.tables = DataTable$1.fnTables = function ( visible )
{
	var api = false;
	...
	var a = $.map( DataTable$1.settings, function (o) {
...
_api_register( 'destroy()', function ( remove ) {
	...
	return this.iterator( 'table', function ( settings ) {
		...
		var idx = $.inArray( settings, DataTable$1.settings );
		if ( idx !== -1 ) {
...
DataTable$1.defaults = {
	 ...
	 *    } )
	 */
	"oSearch": $.extend( {}, DataTable$1.models.oSearch ),
...
$.extend( DataTable$1.ext.classes, {
	"sTable": "dataTable",
	"sNoFooter": "no-footer",
...
$.extend( true, DataTable$1.ext.renderer, {
	pageButton: {
...
$.extend( DataTable$1.ext.type.detect, [
...
$.extend( DataTable$1.ext.type.search, {
	html: function ( data ) {
		return _empty(data) ?
			data :
			typeof data === 'string' ?
...
function __mlHelper (localeString) {
	return function ( from, to, locale, def ) {
		...
		if (! DataTable$1.ext.type.order[typeName]) {
			...
			DataTable$1.ext.type.detect.unshift(function (d) {
				return d === typeName ? typeName : false;
			});

			// The renderer gives us Moment, Luxon or Date obects for the sorting, all of which have a
			// `valueOf` which gives milliseconds epoch
			DataTable$1.ext.type.order[typeName + '-asc'] = function (a, b) {
				var x = a.valueOf();
				var y = b.valueOf();
			...
			DataTable$1.ext.type.order[typeName + '-desc'] = function (a, b) {
				var x = a.valueOf();
				var y = b.valueOf();
...
DataTable$1.datetime = function ( format, locale ) {
	...
	if (! DataTable$1.ext.type.order[typeName]) {
		...
		DataTable$1.ext.type.order[typeName + '-pre'] = function (d) {
...
{
	return function() {
		var args = [_fnSettingsFromNode( this[DataTable$1.ext.iApiIndex] )].concat(
			Array.prototype.slice.call(arguments)
		);
		return DataTable$1.ext.internal[fn].apply( this, args );
	};
}
 ...
 *  @namespace
 */
$.extend( DataTable$1.ext.internal, {
...
// jQuery access
$.fn.dataTable = DataTable$1;

// Provide access to the host jQuery object (circular reference)
DataTable$1.$ = $;

// Legacy aliases
$.fn.dataTableSettings = DataTable$1.settings;
$.fn.dataTableExt = DataTable$1.ext;
...
$.each( DataTable$1, function ( prop, val ) {
	$.fn.DataTable[ prop ] = val;
} );

var jquery_dataTables = /*#__PURE__*/Object.freeze({
	__proto__: null,
	default: DataTable$1
});

var dataTables_responsive$1 = {exports: {}};

var require$$1 = /*@__PURE__*/getAugmentedNamespace(jquery_dataTables);

/*! Responsive 2.5.0
 * © SpryMedia Ltd - datatables.net/license
 */
var dataTables_responsive = dataTables_responsive$1.exports;

var hasRequiredDataTables_responsive;

function requireDataTables_responsive () {
	if (hasRequiredDataTables_responsive) return dataTables_responsive$1.exports;
	hasRequiredDataTables_responsive = 1;
	(function (module, exports) {
		(function( factory ){
			if ( typeof undefined === 'function' && undefined.amd ) {
				// AMD
				undefined( ['jquery', 'datatables.net'], function ( $ ) {
					return factory( $, window, document );
				} );
			}
			else if ( 'object' === 'object' ) {
				// CommonJS
				var jq = requireJquery();
		...
		$.extend(Responsive.prototype, {
			...
			_childNodesRestore: function (dt, row, col) {
				...
				this.s.childNodeStore[name] = undefined$1;
			},
			...
			_classLogic: function () {
				...
				var columns = dt
					...
					.map(function (i) {
						...
						if (priority === undefined$1) {
							priority =
								dataPriority === undefined$1 || dataPriority === null
									? 10000
									: dataPriority * 1;
						}
	...
	} (dataTables_responsive$1, dataTables_responsive$1.exports));
	return dataTables_responsive$1.exports;
}

var dataTables_responsiveExports = requireDataTables_responsive();
var Responsive = /*@__PURE__*/getDefaultExportFromCjs(dataTables_responsiveExports);

var dataTables_select$1 = {exports: {}};

/*! Select for DataTables 1.7.0-dev
 * © SpryMedia Ltd - datatables.net/license/mit
 */
var dataTables_select = dataTables_select$1.exports;

var hasRequiredDataTables_select;

function requireDataTables_select () {
	if (hasRequiredDataTables_select) return dataTables_select$1.exports;
	...
	(function (module, exports) {
		...
		DataTable.select.init = function (dt) {
			...
			var selectAndSave = function (e, settings, data) {
				if (data === null || data.select === undefined$1) {
					return;
				}
				...
				if (data.select.rows !== undefined$1) {
				...
				if (data.select.columns !== undefined$1) {
				...
				if (data.select.cells !== undefined$1) {
			...
			dt.on('stateSaveParams', function (e, settings, data) {
				...
				.one('init', function () {
					selectAndSave(undefined$1, undefined$1, savedSelected);
				});

			var init = ctx.oInit.select;
			var defaults = DataTable.defaults.select;
			var opts = init === undefined$1 ? defaults : init;
			...
			api.on('preXhr.dt.dtSelect', function (e, settings) {
				...
				var cells = api
					...
					.map(function (cellIdx) {
						...
						return id ? { row: id, column: cellIdx.column } : undefined$1;
					})
					.filter(function (d) {
						return d !== undefined$1;
					});
...
const DataTable = class {
    ...
    itemSelectHandler = (_e, _dt, type, indexes) => {
        if (type === 'row') {
            const item = this._table.rows(indexes).data().pluck('id');
            this.itemSelect.emit(item);
            this.responsive();
        }
    };
    itemDeSelectHandler = (_e, _dt, type, indexes) => {
        if (type === 'row') {
            const item = this._table.rows(indexes).data().pluck('id');
    ...
    componentDidLoad() {
        const dt = DataTable$1.call(window);
        const s = Select(window, $$1);
        const rwd = Responsive(window, $$1);
        const table = (this._table = new dt($$1(this.host.querySelector('table')), {
            data: this.dataSet,
            ...
            dom: '<"dataTable-top">' + '<"dataTable-container"tr>' + '<"dataTable-bottom"p>',
        }));
        $$1("input[class='dataTable-input']").on('keyup', function () {
            table.search($$1(this).val()).draw();
        });
        table.on('select', this.itemSelectHandler);
        table.on('deselect', this.itemDeSelectHandler);
        console.log(rwd);
        new rwd(table, {
            target: 0,
        });
        //s.init(table);
        console.log(s);
        // var select = Select(window, $)
        // function outputsize(){
        //   r.s.dt.responsive.rebuild();
        //   r.s.dt.responsive.recalc();
        // }
        //
        // new ResizeObserver(outputsize).observe(this.host.querySelector(".table-responsive"));
        //$(this.host.querySelector("table")).resizable();
        //
        ...
        //         min: { width: 450, height: 50 }
        //       })
        //     ],
        //
        //     inertia: true
        //   })
        const container = this.host.querySelector('.dataTables_scrollBody');
    ...
    render() {
        ...
        return (h("div", { key: 'd95fd16612ba06ae334b1a09351185259477e4ea', class: "table-responsive" }, h("div", { key: '03eeeb1e748c320ca509098706280e5ea6026e68', class: "dataTable-wrapper dataTable-loading no-footer sortable searchable fixed-columns" }, h("div", { key: 'd97444ae3816eae6c74d48cba81f71fcc3305bdc', class: "dataTable-top" }, h("div", { key: 'ecff1d1543b6a49f0423e1826a098fac7354de20', class: "dataTable-search" }, h("input", { key: 'a6a69f10428b59079a3ff044a49df135c56c1f43', class: "dataTable-input", placeholder: "\u641C\u5C0B...", type: "text" }))), h("div", { key: '24341f2ffb9d75db24ec57af759c6913caa15e6f', class: "dataTable-container" }, h("table", { key: 'a22f6923e0b15d30f5156b10329b3829099b5ecc', class: "table table-flush dataTable-table responsive", style: { width: '100%' } }, h("thead", { key: '4d156d092497d55d86c0f2f0f463afa9f775450e' }), h("tbody", { key: 'c23636b30f192b5fe082c8d0ed04abd7482a1122' }))))));
    }
};
DataTable.style = stormDataTableCss;

export { DataTable as storm_data_table };
//# sourceMappingURL=storm-data-table.entry.esm.js.map

//# sourceMappingURL=storm-data-table.entry.js.map